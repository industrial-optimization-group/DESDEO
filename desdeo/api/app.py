...
from desdeo.api.routers import NIMBUS, NAUTILUS_navigator, UserAuth, problems, test, NAUTILUS, NAUTILUS_navigator_group
...
app.include_router(NAUTILUS_navigator_group.router)
