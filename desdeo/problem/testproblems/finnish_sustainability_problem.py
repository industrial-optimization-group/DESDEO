...
def finnish_sustainability_problem():
    """Implements the Finnish sustainability problem."""
    coefficients_dict = {
        "social_linear": {
            "x_1": -0.00982,
            "x_2": 0.0,
        ...
        "upper_bounds": {
            ...
            "x_9": 70,
            "x_10": 105,
            "x_11": 115,  # In the paper is 85, but it seems to be a typo as the initial solution is 115 and the upper bound should be higher than that.
        },
    }

    social_cte_value = 0.197  # verify
    economical_cte_value = 0.74  # verfy
    enviro_cte_value = 2.92  # verify
    ...
    return Problem(
        name="Finnish sustainability problem.",
