...
def test_proximal_with_simple_data_problem():
    ...
    const_should_be = [variable_values["y_1"][-1] + variable_values["y_2"][-1] - 10]
    ...
    npt.assert_array_almost_equal([res.optimal_objectives[symbol][0] for symbol in objective_symbols], obj_should_be)
    npt.assert_array_almost_equal(res.constraint_values[const_symbol][0], const_should_be)
    ...
    const_should_be = [variable_values["y_1"][0] + variable_values["y_2"][0] - 10]
    ...
    const_should_be = [variable_values["y_1"][4] + variable_values["y_2"][4] - 10]
