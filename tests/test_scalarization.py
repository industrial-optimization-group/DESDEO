...
def test_add_asf_generic_diff():
    ...
    # check that reference point in augmentation term returns a different solution
    assert all(fs[obj.symbol] != fs_aug[obj.symbol] for obj in problem_w_asf.objectives)
