<script lang="ts">
	...
	import { SIGNIFICANT_DIGITS } from '$lib/constants/index.js';
	...
	const objectiveNames: Record<string, string> = $derived(
		Object.fromEntries(problem.objectives.map((obj) => [obj.symbol, obj.name ?? obj.symbol]))
	);
