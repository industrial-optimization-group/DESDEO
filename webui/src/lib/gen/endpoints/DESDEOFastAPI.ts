...
import type {
	...
	SaveMethodPreferenceMethodGenericSaveMethodPreferencePostParams,
...
export const getGetProblemProblemProblemIdGetUrl = (problemId: number | null) => {
...
export const getProblemProblemProblemIdGet = async (
	...
	return customFetch<getProblemProblemProblemIdGetResponse>(
		getGetProblemProblemProblemIdGetUrl(problemId),
		{
			...options,
			method: 'GET',
...
export const getDeleteProblemProblemProblemIdDeleteUrl = (problemId: number | null) => {
	return `http://localhost:8000/problem/${problemId}`;
};
...
export const getGetAllRepresentativeSolutionSetsProblemProblemIdAllRepresentativeSolutionSetsGetUrl =
	(problemId: number | null) => {
		return `http://localhost:8000/problem/${problemId}/all_representative_solution_sets`;
	};
...
export const getGetProblemJsonProblemProblemIdJsonGetUrl = (problemId: number | null) => {
 ...
 * @summary Get Final Solutions
 */
export type getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetResponse200 = {
	data: FinalSolutionsResponse;
	status: 200;
};

export type getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetResponse422 = {
	data: HTTPValidationError;
	status: 422;
};

export type getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetResponseSuccess =
	getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetResponse200 & {
		headers: Headers;
	};
export type getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetResponseError =
	getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetResponse422 & {
		headers: Headers;
	};

export type getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetResponse =
	| getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetResponseSuccess
	| getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetResponseError;

export const getGetFinalSolutionsMethodGenericFinalSolutionsProblemIdGetUrl = (
	problemId: number | null
) => {
	return `http://localhost:8000/method/generic/final-solutions/${problemId}`;
};

export const getFinalSolutionsMethodGenericFinalSolutionsProblemIdGet = async (
	problemId: number | null,
	rPMSolveRequestENautilusStepRequestCreateSessionRequestNull:
		| RPMSolveRequest
		| ENautilusStepRequest
		...
		| null,
	options?: RequestInit
): Promise<getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetResponse> => {
	return customFetch<getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetResponse>(
		getGetFinalSolutionsMethodGenericFinalSolutionsProblemIdGetUrl(problemId),
		{
			...options,
			method: 'GET',
			headers: { 'Content-Type': 'application/json', ...options?.headers },
 ...
 * @summary Save Method Preference
 */
export type saveMethodPreferenceMethodGenericSaveMethodPreferencePostResponse200 = {
	data: MethodPreferenceResponse;
	status: 200;
};

export type saveMethodPreferenceMethodGenericSaveMethodPreferencePostResponse422 = {
	data: HTTPValidationError;
	status: 422;
};

export type saveMethodPreferenceMethodGenericSaveMethodPreferencePostResponseSuccess =
	saveMethodPreferenceMethodGenericSaveMethodPreferencePostResponse200 & {
		headers: Headers;
	};
export type saveMethodPreferenceMethodGenericSaveMethodPreferencePostResponseError =
	saveMethodPreferenceMethodGenericSaveMethodPreferencePostResponse422 & {
		headers: Headers;
	};

export type saveMethodPreferenceMethodGenericSaveMethodPreferencePostResponse =
	| saveMethodPreferenceMethodGenericSaveMethodPreferencePostResponseSuccess
	| saveMethodPreferenceMethodGenericSaveMethodPreferencePostResponseError;

export const getSaveMethodPreferenceMethodGenericSaveMethodPreferencePostUrl = (
	params?: SaveMethodPreferenceMethodGenericSaveMethodPreferencePostParams
) => {
	const normalizedParams = new URLSearchParams();
	...
	return stringifiedParams.length > 0
		? `http://localhost:8000/method/generic/save-method-preference?${stringifiedParams}`
		: `http://localhost:8000/method/generic/save-method-preference`;
};

export const saveMethodPreferenceMethodGenericSaveMethodPreferencePost = async (
	methodPreferenceRequest: MethodPreferenceRequest,
	params?: SaveMethodPreferenceMethodGenericSaveMethodPreferencePostParams,
	options?: RequestInit
): Promise<saveMethodPreferenceMethodGenericSaveMethodPreferencePostResponse> => {
	return customFetch<saveMethodPreferenceMethodGenericSaveMethodPreferencePostResponse>(
		getSaveMethodPreferenceMethodGenericSaveMethodPreferencePostUrl(params),
		{
			...options,
			method: 'POST',
			headers: { 'Content-Type': 'application/json', ...options?.headers },
			body: JSON.stringify(methodPreferenceRequest)
		}
	);
};
