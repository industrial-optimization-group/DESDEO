...
export const GetCurrentUserInfoUserInfoGetResponse = zod
	.object({
		...
		experiment_group: zod.union([zod.number(), zod.null()])
	})
 ...
 */
export const GetFinalSolutionsMethodGenericFinalSolutionsProblemIdGetParams = zod.object({
	problem_id: zod.union([zod.number(), zod.null()])
});

export const getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetBodyOnePreferencePreferenceTypeDefault = `reference_point`;

export const GetFinalSolutionsMethodGenericFinalSolutionsProblemIdGetBody = zod.union([
	zod
		.object({
			problem_id: zod.number(),
			session_id: zod.union([zod.number(), zod.null()]).optional(),
			...
			preference: zod
				.object({
					preference_type: zod
						.literal('reference_point')
						.default(
							getFinalSolutionsMethodGenericFinalSolutionsProblemIdGetBodyOnePreferencePreferenceTypeDefault
						),
					aspiration_levels: zod.record(zod.string(), zod.number())
				})
				.optional()
...
export const GetFinalSolutionsMethodGenericFinalSolutionsProblemIdGetResponse = zod
	.object({
		nimbus_final: zod
			.union([
				zod
	...
	.describe('Response containing the latest NIMBUS_FINAL and XNIMBUS_FINAL solutions.');
 ...
 */
export const SaveMethodPreferenceMethodGenericSaveMethodPreferencePostQueryParams = zod.object({
	problem_id: zod.union([zod.number(), zod.null()]).optional()
});

export const SaveMethodPreferenceMethodGenericSaveMethodPreferencePostBody = zod
	.object({
		preferred_method: zod.string()
	})
	.describe("Request to save user's method preference.");

export const SaveMethodPreferenceMethodGenericSaveMethodPreferencePostResponse = zod
	.object({
		success: zod.boolean(),
		message: zod.string(),
		preferred_method: zod.string()
	})
	.describe('Response after saving method preference.');
