 ...
 */
import type { TensorVariableDBInitialValues } from './tensorVariableDBInitialValues';
import type { TensorVariableDBLowerbounds } from './tensorVariableDBLowerbounds';
import type { TensorVariableDBUpperbounds } from './tensorVariableDBUpperbounds';
import type { VariableTypeEnum } from './variableTypeEnum';
import type { TensorVariableDBId } from './tensorVariableDBId';
import type { TensorVariableDBProblemId } from './tensorVariableDBProblemId';

/**
 * The SQLModel equivalent to `TensorVariable`.
 */
export interface TensorVariableDB {
	initial_values: TensorVariableDBInitialValues;
	lowerbounds: TensorVariableDBLowerbounds;
	upperbounds: TensorVariableDBUpperbounds;
	shape: number[];
	...
	id?: TensorVariableDBId;
	problem_id?: TensorVariableDBProblemId;
}
